...
?>
<nav>
	<ul id="menu-job-department" class="menu-job-department">
	...
	?>
			<div class="job-one" <?php echo is_null($job_department_id) == false ? ' data-job-department="'.$job_department_id.'"' : ''?>>
				<?php if($job_department_title): ?>
					<div class="department"><?php echo $job_department_title ?></div>
				<?php endif; ?>
				<div>
				<h2><?php echo the_title(); ?></h2>
				</div>
				<?php if($location_title): ?>
					<div class="location"><?php echo $location_title ?></div>
				<?php endif; ?>
			</div>
